...
var MarkdownComplexityReporter = (function (_super) {
  ...
  MarkdownComplexityReporter.prototype.formatModule = function (report) {
    var ret = [];
    var complexity, duplicates, lint;

    complexity = this.formatComplexity(report.complexity);
    if (complexity) ret.push(complexity);
  ...
  MarkdownComplexityReporter.prototype.formatComplexity = function (report) {
    var ret, functions;
